...
<h1 style="text-align: left;">Presentations</h1>

<style>
  /* alignment + hanging indent (matches Publications styling) */
  .pres, .pres li {
  ...
  .pres { list-style-type: disc; padding-left: 0; margin: 0; }
  .pres li { margin-bottom: 1.5rem; padding-left: 1.2em; text-indent: -1.2em; }
  .pres a { overflow-wrap: anywhere; word-break: break-word; }

  /* FORCE normal text color for this section */
  .pres { color: #111 !important; }
  .pres * { color: inherit !important; }
</style>
